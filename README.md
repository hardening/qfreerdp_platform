...
| `norootwindow` | `norootwindow`            | windowId 1 is root window | By default the first created window has a special role and is never decorated, this option allow to disable this behaviour |
